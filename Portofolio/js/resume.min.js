...
$(".loadDiv").click(function (event) {
 ...
 $(document).ready(function () {
  ...
  if(url.includes("https://")){
    ...
    alertify.alert("<h5>The content of this Portfolio will not be shown if not in safe mode </h5><br> SSL Link <br><a href='https://vunf1.coventry.domains'> Click here</a>");
    $(".ok").text('Thank You'); 
    
    $("#loading").css("display","none");
    $(".caixa").html("<div class='alert alert-danger' role='alert'>Content will not be shown unless you loaded the portfolio correctly <a href='https://vunf1.coventry.domains'> Click here</a></div>");
  }
});


function rooty(){ //load root folder into Dialog modal
  ...
  $.ajax({
    url:"https://vunf1.coventry.domains/root_folder_project/root.php",
    method:"POST",
    dataType:'text',
    data:'',
    success:function(data){
