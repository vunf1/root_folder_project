$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
    ...
    "columns": [
      { "data": "Id" },
      { "data": "serial",   "sClass": "company_name" },
      { "data": "hwfingerprint" },
      { "data": "expirationdate",        "sClass": "integer" },
      { "data": "period",    "sClass": "integer" },
      { "data": "lictype",      "sClass": "integer" },
  ...
  $(document).on('click', '#add_company', function(e){
    ...
    $('#form_company #Id').val('');
    $('#form_company #serial').val('');
    $('#form_company #hwfingerprint').val('');
    $('#form_company #expirationdate').val('');
    $('#form_company #period').val('');
    $('#form_company #lictype').val('');
