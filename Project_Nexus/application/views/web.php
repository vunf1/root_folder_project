...
<html lang="en">
  ...
  <body>
    ...
    <script type="text/javascript" src="<?php base_url()?>js/jquery.1.11.1.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script type="text/javascript" src="<?php base_url()?>js/bootstrap.js"></script>
    <script type="text/javascript" src="<?php base_url()?>js/SmoothScroll.js"></script>
    <script type="text/javascript" src="<?php base_url()?>js/jquery.isotope.js"></script>
