...
function load_dashboard_solution(data){
  ...
  console.log("-------------------------");
        $.each ( data, function ( key, val ) {
          ...
          rename_tr="<tr><td><img id=so_lo src='https://vunf1.coventry.domains/root_folder_project/Project_Nexus/assets/images/logo_"+true_val+".png'></td><td>"+true_val+"</td><td class='text-center'><a class='btn btn-info btn-xs' id='edit_"+true_val+"' data-title='"+true_val+"' data-toggle='modal' data-target='.bd-example-modal-sm' ><span class='glyphicon glyphicon-edit'></span> Edit</a> <a id='del_"+true_val+"' data-title='"+true_val+"' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-remove' ></span> Del</a></td></tr>"
